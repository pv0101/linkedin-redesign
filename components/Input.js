...
function Input() {
    ...
    const [modalOpen, setModalOpen] = useRecoilState(modalState)//used to change modalState atom, changes will be reflected anywhere in application
  ...
  return (
    <div className="bg-white dark:bg-[#1D2226] rounded-lg p-3 space-y-3 border border-gray-300 darK:border-none">
        ...
        <div className="flex items-center flex-wrap gap-4 justify-center md:gap-x-10">
            {/* whole button is group. When hover over group, only h4 opacity changes */}
